<form action="/projeto/usuario/inserir" method="post">
    ...
    <div class="form-container">
        ...
        <label>Nome:</label>
        <input class="text-box" placeholder="Digite seu nome" name="nome" value="<?= ($parametro != null) ? $parametro[0]["nome"] : "" ?>" />
        <br />
        <label>Email:</label>
        <input class="text-box" placeholder="Digite seu e-mail" type="text" name="email" value="<?= ($parametro != null) ? $parametro[0]["email"] : "" ?>" />
        <br />
        ...
        <br />
        <label>Senha:</label>
        <input class="text-box" placeholder="Digite sua senha" type="password" name="senha" value="<?= ($parametro != null) ? $parametro[0]["senha"] : "" ?>" />
        <br />
