...
<div class="form-container">
    ...
    <form action="/projeto/casa/inserir" method="post">
        ...
        ?>
        <label>Bairro:</label>
        <input class="text-box" type="text" name="bairro" value="<?= ($parametro != null) ? $parametro[0]["bairro"] : "" ?>" />
        <br />
        <label>Metros:</label>
        <input class="text-box" type="text" name="metros" value="<?= ($parametro != null) ? $parametro[0]["metros"] : "" ?>" />
        <br />
        <label>Quantidade comodos:</label>
        <input class="text-box" type="text" name="comodos" value="<?= ($parametro != null) ? $parametro[0]["quantidade_comodos"] : "" ?>" />
        <br />
        <label>Valor R$:</label>
        <input class="text-box" type="text" name="valor" value="<?= ($parametro != null) ? $parametro[0]["valor_estimado"] : "" ?>" />
