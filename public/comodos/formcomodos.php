...
<div class="form-container">
    ...
    <form action="/projeto/comodo/inserir" method="post">
        ...
        <label>Comodo:</label>
        <input class="text-box" type="text" name="comodo" value="<?= ($parametro != null) ? $parametro[0]["comodo"] : "" ?>" />
        <br />


        <label>Área:</label>
        <input class="text-box" type="text" name="area" value="<?= ($parametro != null) ? $parametro[0]["area"] : "" ?>" />
